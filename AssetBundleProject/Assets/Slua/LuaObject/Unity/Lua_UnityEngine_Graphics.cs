...
public class Lua_UnityEngine_Graphics : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ForceRenderBufferLoadActionLoad_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Boolean a1;
			checkType(l,1,out a1);
			UnityEngine.Graphics.ForceRenderBufferLoadActionLoad(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,ForceRenderBufferLoadActionLoad_s);
